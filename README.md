...
1. **Дерево**:
   ...
   - **Лесопилка**: увеличивает добычу дерева на 3 единицы за ход, +50% за каждый уровень после первого

2. **Руда**:
   - **Изначальное количество в начале игры**: 10 единиц.
   - **Базовый прирост**: 1 единица руды в ход.
   - **Шахта**: увеличивает добычу руды на 3 единицы за ход, +50% за каждый уровень после первого

3. **Камень**:
   - **Изначальное количество в начале игры**: 10 единиц.
   - **Базовый прирост**: 1 единица камня в ход.
   - **Карьер**: увеличивает добычу камня на 3 единицы за ход, +50% за каждый уровень после первого

4. **Золото**:
   - **Изначальное количество в начале игры**: 15 единиц.
   - **Базовый прирост**: 1 единица золота в ход плюс 1 единица за каждую клетку территории.

5. **Воины**:
   - **Изначальное количество в начале игры**: 2 единицы.
...
2. **Содержание воинов**:
   - **Стоимость содержания одного воина в день**: 0.5 единицы золота.
...
Улучшения:
   - **Лесопилка**: каждый уровень выше первого увеличивает производство на 50% (уровень 2: +4.5, уровень 3: +6 за ход).
   - **Шахта**: каждый уровень выше первого увеличивает производство на 50% (уровень 2: +4.5, уровень 3: +6 за ход).
   - **Карьер**: каждый уровень выше первого увеличивает производство на 50% (уровень 2: +4.5, уровень 3: +6 за ход).
   - **Склад**: каждое улучшение даёт +50 к максимальному запасу всех ресурсов.
   - **Казарма**: каждое улучшение даёт +10 к максимальному количеству воинов у фракции.
